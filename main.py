...
#item.configureMultipleFromRange("192.168.1.15", "192.168.1.17", command_path='backend/list_of_commands.txt', privelege=True, silent=False, mode="check", backup=True)
